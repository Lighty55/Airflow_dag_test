...
args = {
    "project_id": "flights-model-please-run-0427071939",
}

dag = DAG(
    "flights-model-please-run-0427071939",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-model-please-run.pipeline.",
...
notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-model-please-run-0427071939",
    ...
    env_vars={
        ...
        "CONTAINER_DETAILS": "lighty55/container-model:2.0.0",
    },
    config_file="None",
    dag=dag,
)

notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98.image_pull_policy = "IfNotPresent"
...
notebook_op_a8a2be4d_dfd1_4a0a_9ce5_5477d6bf8b56 = NotebookOp(
    ...
    env_vars={
        ...
        "MODEL_NAME": "flights-ontime",
        "MODEL_VERSION": "1",
        "CONTAINER_DETAILS": "quay.io/lighty55/container-model:2.0.0",

...
args = {
    "project_id": "flights-model-test-0426085153",
}

dag = DAG(
    "flights-model-test-0426085153",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-model-test.pipeline.",
...
notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-model-test-0426085153",
...
notebook_op_a8a2be4d_dfd1_4a0a_9ce5_5477d6bf8b56 = NotebookOp(
    ...
    env_vars={
        ...
        "MODEL_NAME": "flights-ontime",
        "MODEL_VERSION": "1",
        "CONTAINER_DETAILS": "quay.io/ml-on-k8s/container-model:2.0.0",
        "CLUSTER_DOMAIN_NAME": "192.168.39.216.nip.io",
    },
    config_file="None",
    dag=dag,
)

...
args = {
    "project_id": "flights-test-1028070350",
}

dag = DAG(
    "flights-test-1028070350",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-test.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    notebook="lost+found/Machine-Learning-on-Kubernetes/Chapter09/pipeline-helpers/start-spark-cluster.py",
    cos_endpoint="http://minio-ml-workshop:9000/",
    cos_bucket="airflow",
    cos_directory="flights-test-1028070350",
...
notebook_op_5ad53c7e_c1a5_4dab_b766_cd6e3642891a = NotebookOp(
    ...
    namespace="ml-workshop",
    task_id="merge_data",
    notebook="lost+found/Machine-Learning-on-Kubernetes/Chapter09/merge_data.ipynb",
    cos_endpoint="http://minio-ml-workshop:9000/",
    cos_bucket="airflow",
    cos_directory="flights-test-1028070350",
...
notebook_op_b6d6a9d3_65b6_4ef6_9ce8_4d713bea5e2f = NotebookOp(
    ...
    notebook="lost+found/Machine-Learning-on-Kubernetes/Chapter09/pipeline-helpers/stop-spark-cluster.py",
    cos_endpoint="http://minio-ml-workshop:9000/",
    cos_bucket="airflow",
    cos_directory="flights-test-1028070350",

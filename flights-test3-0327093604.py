...
args = {
    "project_id": "flights-test3-0327093604",
}

dag = DAG(
    "flights-test3-0327093604",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-test3.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-test3-0327093604",
...
notebook_op_1b1d75b3_6cab_465a_b6f1_2e5d2e063959 = NotebookOp(
    name="clean_data",
    namespace="ml-workshop",
    task_id="clean_data",
    ...
    cos_bucket="airflow",
    cos_directory="flights-test3-0327093604",
    cos_dependencies_archive="clean_data-1b1d75b3-6cab-465a-b6f1-2e5d2e063959.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=["spark-info.txt"],
    image="quay.io/ml-on-k8s/airflow-python-runner:0.0.11",
    in_cluster=True,
...
notebook_op_1b1d75b3_6cab_465a_b6f1_2e5d2e063959.image_pull_policy = "IfNotPresent"

(
    notebook_op_1b1d75b3_6cab_465a_b6f1_2e5d2e063959
    << notebook_op_5ad53c7e_c1a5_4dab_b766_cd6e3642891a
)
